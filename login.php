...
<html>
    ...
    <!-- start section login -->  
        ...
        <section class="login text-center"> 
            <h1> login </h1>
            <form method="post">
                <input class="form-control user-login name" type="text" name="" placeholder="Table Number">
                <span class="warn warn1"></span>
                <input class="form-control user-login password" type="password" name="" placeholder="Password">
